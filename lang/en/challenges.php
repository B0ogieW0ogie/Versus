...
return [
    ...
    'stay' => 'Stay',
    'upload' => 'Upload',
    'upload_hint' => 'Tap to upload video or record now',
    'trim' => 'Trim',
    'trim_start' => 'Trim start',
    'trim_end' => 'Trim end',
    'trim_hint' => 'Drag the edges to keep the part you want',
    'trim_hint_before' => 'After picking a video you can trim it to :seconds s',
    'trim_invalid' => 'Pick a part between 1 and :seconds seconds',
    'seconds_short' => 's',
    'replace_video' => 'Replace',
    'response_title' => 'Create Response',
    'response_locked_hint' => 'Title, rules, category and deadline come from the Challenge and can\'t be changed. After publishing, your Response can\'t be replaced.',
    'invite_link' => 'Invite link',
    'invite_link_after' => 'Available after publishing — copy it in My Challenges',
    'copy_invite' => 'Copy invite link',
    'upload_formats' => 'Vertical video · up to :mb MB',
