...
return [
    ...
    'create_intro' => 'Укажите подписи сторон и время закрытия голосования. Название батла собирается из двух подписей (A VS B). После публикации батл сразу становится активным.',
