...
return [
    ...
    'create_intro' => 'Задайте стороны и время закрытия голосования. Батл сразу становится активным после публикации.',
    'create_field_title' => 'Название',
    'create_field_description' => 'Описание (необязательно)',
    'create_field_side_a' => 'Подпись стороны A',
    'create_field_side_b' => 'Подпись стороны B',
    ...
    'create_field_category' => 'Категория (необязательно)',
    'create_category_none' => '— Без категории —',
