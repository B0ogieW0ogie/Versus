<div>
    <span id="onboarding-step-marker" class="sr-only" data-step="{{ $active ? $step : '' }}"></span>
    <div id="onboarding-curtains" class="fixed inset-0 z-[65] pointer-events-none" style="display: none"></div>
    ...
    @if ($active)
        ...
        <div class="fixed inset-0 z-[72] pointer-events-none" wire:key="onboarding-ui-{{ $step }}">
            <div class="fixed z-[73] w-[min(calc(100vw-2rem),20rem)] rounded-2xl border border-white/15 bg-navy-900 p-4 shadow-2xl pointer-events-auto"
