...
return [
    ...
    // Form
    'create_title' => 'Создать челлендж',
    'create_subtitle' => 'Поделитесь идеей и бросьте вызов миру!',
    'leave_confirm' => 'Выйти без сохранения?',
    'leave' => 'Выйти',
    'stay' => 'Остаться',
    'upload' => 'Загрузить',
    'upload_hint' => 'Нажмите, чтобы загрузить видео или записать',
    'trim' => 'Обрезка',
    'trim_start' => 'Начало',
    'trim_end' => 'Конец',
    'trim_hint' => 'Перетащите края, чтобы оставить нужный отрезок',
    'trim_hint_before' => 'После выбора видео его можно обрезать до :seconds с',
    'trim_invalid' => 'Выберите отрезок от 1 до :seconds секунд',
    'seconds_short' => 'с',
    'replace_video' => 'Заменить',
    'response_title' => 'Создать Response',
    'response_locked_hint' => 'Название, правила, категория и срок берутся из Challenge и не меняются. После публикации Response нельзя заменить другим видео.',
    'invite_link' => 'Ссылка-приглашение',
    'invite_link_after' => 'Появится после публикации — её можно скопировать в My Challenges',
    'copy_invite' => 'Скопировать приглашение',
    'upload_formats' => 'Вертикальное видео · до :mb МБ',
    'upload_done' => 'Видео загружено',
    'record' => 'Записать',
    'record_start' => 'Начать',
    'record_stop' => 'Стоп',
    'record_cancel' => 'Отмена',
    'camera_denied' => 'Нет доступа к камере — разрешите его в браузере или загрузите файл',
    ...
    'duration_3d' => '3 дня',
    'duration_7d' => '7 дней',
    'duration_14d' => '14 дней',
    'duration_30d' => '30 дней',
    'deadline_hint' => 'После дедлайна новые ответы и голоса не принимаются',
    'field_category' => 'Категория',
    'select_category' => 'Выберите категорию',
    'category_sports' => 'Спорт и фитнес',
    'category_music' => 'Музыка и танцы',
    'category_gaming' => 'Игры',
    'category_creativity' => 'Творчество',
    'category_skills' => 'Навыки и знания',
    'category_lifestyle' => 'Лайфстайл и развлечения',
    'category_other' => 'Другое',
    'field_format' => 'Формат',
    'format_public' => 'Public Challenge',
    'format_public_hint' => 'Участвовать может любой пользователь',
    'format_duel' => 'Duel',
    'format_duel_hint' => '1 на 1 с выбранным соперником. Смотреть и голосовать может любой',
    'field_opponent' => 'Соперник',
    'opponent_placeholder' => 'Поиск по @username или имени',
    'opponent_none' => 'Никого не нашли',
    'opponent_change' => 'Изменить',
    'opponent_hint' => 'Ответы публикуете только вы и соперник. Дуэль остаётся публичной',
    'duel_badge' => 'Дуэль 1v1',
    'duel_vs' => 'против :opponent',
    'time_left' => 'Осталось',
    ...
    'format_required' => 'Выберите формат',
    'opponent_required' => 'Выберите соперника для дуэли',
    'opponent_self' => 'Нельзя вызвать на дуэль самого себя',
    'duel_only' => 'Ответить на эту дуэль может только приглашённый соперник',
    ...
    'notif_duel_invitation' => ':name вызывает вас на дуэль «:title»',
