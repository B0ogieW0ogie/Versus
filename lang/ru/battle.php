...
return [
    ...
    'battle_stake_cap_reached' => 'В одном баттле можно поставить не более :max токенов. Осталось в этом баттле: :remaining.',
    'amount_label' => 'Голоса',
    ...
    'stake_modal_title' => 'Ваша ставка: __N__ VS',
    'stake_modal_body' => 'Отправка токенов в пул без подтверждения.',
    'stake_modal_dismiss' => 'Понятно',
